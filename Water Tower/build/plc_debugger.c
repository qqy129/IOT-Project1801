...
{&(RES0__INST0.LEVEL), INT_ENUM},
{&(RES0__INST0.LEVEL_FILTERED), INT_ENUM},
{&(RES0__INST0.MIN_SP), INT_ENUM},
{&(RES0__INST0.MAX_SP), INT_ENUM},
{&(RES0__INST0.MODE_REGISTER), INT_ENUM},
{&(RES0__INST0.PUMP_REGISTER), INT_ENUM},
{&(RES0__INST0.VALVE_REGISTER), INT_ENUM},
{&(RES0__INST0.PUMP), BOOL_ENUM},
{&(RES0__INST0.VALVE), BOOL_ENUM},
{&(RES0__INST0.PUMP_MAN), BOOL_ENUM},
{&(RES0__INST0.PUMP_AUTO), BOOL_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.EN), BOOL_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.ENO), BOOL_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.RAW_LEVEL), INT_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.LEVEL_REAL), REAL_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.AVG), LREAL_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.I), INT_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.CURRENT_ARRAY_POS), INT_ENUM},
{&(RES0__INST0.LEVEL_FILTERING0.FILTERED_LEVEL), INT_ENUM},
{&(RES0__INST0.LE98_OUT), BOOL_ENUM},
{&(RES0__INST0.GE103_OUT), BOOL_ENUM},
{&(RES0__INST0.EQ104_OUT), BOOL_ENUM},
{&(RES0__INST0.EQ33_OUT), BOOL_ENUM},
{&(RES0__INST0.EQ49_OUT), BOOL_ENUM},
{&(RES0__INST0.EQ38_OUT), BOOL_ENUM}
};
